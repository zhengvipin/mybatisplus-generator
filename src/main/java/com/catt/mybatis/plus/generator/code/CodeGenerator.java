package com.catt.mybatis.plus.generator.code;
...
public class CodeGenerator {
    ...
    private static DataSourceConfig initDataSourceConfig() {
        ...
        dsc.setUrl("jdbc:mysql://172.168.63.232:3307/zhwg_trans_conf?useUnicode=true&useSSL=false&characterEncoding=utf8");
    ...
    private static PackageConfig initPackageConfig() {
        ...
        pc.setParent("com.catt.mybatis.plus.generator");
        return pc;
    }
    ...
    private static InjectionConfig initInjectionConfig(PackageConfig pc) {
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                xmlPath.append(PROJECT_PATH).append("/src/main/resources/mapper/");
